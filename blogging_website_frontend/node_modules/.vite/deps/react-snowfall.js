...
var Snowflake = class _Snowflake {
  ...
  updateConfig(config) {
    ...
    if ((previousConfig === null || previousConfig === void 0 ? void 0 : previousConfig.opacity) && !(0, import_react_fast_compare.default)(this.config.opacity, previousConfig === null || previousConfig === void 0 ? void 0 : previousConfig.opacity)) {
