      ...
      <nav ref={navRef} className="navbar mb-[20px]">
        <Link to="/" className="flex items-center gap-3">
          <div className="flex items-center justify-between gap-3">
            <img
              src={logo}
              className="w-[50px] sm:w-[60px] md:w-[65px] lg:w-[70px] h-auto object-contain"
              alt="logo"
            />
        ...
        <div className="flex items-center gap-3 ml-auto xl:hidden">
          ...
          <div className="hidden md:flex">
            <Link
              to="/запис-до-школи"
              className="bg-teal text-white px-4 py-2 rounded-full hover:bg-teal_light transition"
            >
              Записатись
            </Link>
          </div>
          ...
          {/* Бургер*/}
          <button
            className="md:flex xl:hidden p-2 ml-auto w-[40px] h-[40px] flex items-center justify-center"
        ...
        <div className="hidden xl:flex flex items-center gap-8 ml-auto">
          <ul className="flex items-center gap-10 font-montserrat font-semibold text-[18px] text-black">
            <li>
              <Link to="/про-нас">Про нас</Link>
            </li>
            <li className="relative">
              <button
                onClick={() => {
                  setIsTrainersOpen(!isTrainersOpen);
                  setIsMainOpen(false);
                  setIsStopBullyingOpen(false);
                }}
              ...
              >
                Тренери{" "}
                <i className="fi fi-rr-caret-down text-[18px] leading-none"></i>
              </button>
              {isTrainersOpen && (
            ...
            <li>
              <Link to="/розклад-занять">Розклад занять</Link>
            </li>
                      ...
                      <ul className="absolute left-full top-0 mt-2 bg-white shadow-md rounded-md w-64 py-2 z-50">
                        <li>
                          ...
                          >
                            Основні документи
                            <i
                              className={`fi fi-rr-caret-down text-[18px] leading-none transition-transform ${
                                openSubmenu === "documents" ? "rotate-180" : ""
                              }`}
                            ></i>
                          </button>
                          {openSubmenu === "documents" && (
                            <ul className="mt-2 bg-grey shadow-md rounded-md w-64 py-2 z-50">
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-статус"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                              ...
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-правила"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                                  Правила поведінки вихованців ДЮСШ
                                </Link>
                              </li>
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-людиЗОсобливимиПотребами"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                                  Умови доступності закладу для осіб з
                        ...
                        <li>
                          ...
                          >
                            ...
                            <i
                              className={`fi fi-rr-caret-down text-[18px] leading-none transition-transform ${
                                openSubmenu === "programs" ? "rotate-180" : ""
                              }`}
                            ></i>
                          </button>
                          {openSubmenu === "programs" && (
                            <ul className="mt-2 bg-grey shadow-md rounded-md w-64 py-2 z-50">
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-освітняПрограма_на_24-25"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                                  Освітня програма ДЮСШ на 2024–2025 н.р.
                                </Link>
                              </li>
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-навчальніПрограми"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                                  Навчальні програми
                              ...
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-мова_та_оплата"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                                  Мова навчання та оплата
                                </Link>
                              </li>
                            </ul>
                          )}
                        ...
                        <li>
                          ...
                          >
                            ...
                            <i
                              className={`fi fi-rr-caret-down text-[18px] leading-none transition-transform ${
                                openSubmenu === "reports" ? "rotate-180" : ""
                              }`}
                            ></i>
                          </button>
                          {openSubmenu === "reports" && (
                            <ul className="mt-2 bg-grey shadow-md rounded-md w-64 py-2 z-50">
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-звітДиректора"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                                  Звіт директора спортивної школи за 2023–2024
                                  навчальний рік
                                </Link>
                              </li>
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-звіт5ФК"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                                  Звіт 5-ФК за 2024 рік
                                </Link>
                              </li>
                            </ul>
                          )}
                        ...
                        <li>
                          <button
                            ...
                            className="block px-4 py-2 hover:bg-gray-100 transition"
                          >
                            Відділення і учасники
                            <i
                              className={`fi fi-rr-caret-down text-[18px] leading-none transition-transform ${
                                openSubmenu === "branches" ? "rotate-180" : ""
                              }`}
                            ></i>
                          </button>
                          {openSubmenu === "branches" && (
                            <ul className="mt-2 bg-grey shadow-md rounded-md w-64 py-2 z-50">
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-кількістьВихованців"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                                  Відділення та кількість вихованців, які
                                  займаються у ДЮСШ
                                </Link>
                              </li>
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-умовиВступу"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                        ...
                        <li>
                          ...
                          >
                            ...
                            <i
                              className={`fi fi-rr-caret-down text-[18px] leading-none transition-transform ${
                                openSubmenu === "personnel" ? "rotate-180" : ""
                              }`}
                            ></i>
                          </button>
                          {openSubmenu === "personnel" && (
                            <ul className="mt-2 bg-grey shadow-md rounded-md w-64 py-2 z-50">
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-вакансії"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                              ...
                              <li>
                                <Link
                                  to="/інформаційнаПрозорість-cтруктура-та-органи-управління"
                                  className="block px-4 py-2 hover:bg-gray-100 transition"
                                  onClick={() => setOpenSubmenu(false)}
                                >
                  ...
                  <li>
                    ...
                    {isBudgetOpen && (
                      <ul className="absolute left-full top-0 mt-2 bg-white shadow-md rounded-md w-60 py-2 z-50">
                        <li>
                          <Link
                            to="/прозорийБюджет-розрахунок-видатків-на-2025"
                            className="block px-4 py-2 hover:bg-gray-100 transition"
                            onClick={() => setIsBudgetOpen(false)}
                          >
                            Розрахунок видатків на 2025 рік
                          </Link>
                        </li>
                        <li>
                          <Link
                            to="/прозорийБюджет-аналіз-використання-коштів"
                            className="block px-4 py-2 hover:bg-gray-100 transition"
                            onClick={() => setIsBudgetOpen(false)}
                          >
            ...
            <li className="relative">
              <button
                onClick={() => {
                  setIsStopBullyingOpen(!isStopBullyingOpen);
                  setIsTrainersOpen(false);
                  setIsMainOpen(false);
                  toggleSubmenu(false);
                }}
              ...
              {isStopBullyingOpen && (
                <ul className="absolute left-0 top-full mt-2 bg-white shadow-md rounded-md w-80 py-2 z-50">
                  <li>
                    <button
                      onClick={() => toggleSubmenu("documentsBullying")}
                      className="block px-4 py-2 hover:bg-gray-100 transition"
                    >
                    ...
                    {openSubmenu === "documentsBullying" && (
                      <ul className="mt-2 bg-grey shadow-md rounded-md w-80 py-2 z-50">
                        <li>
                          <Link
                            to="/стопБулінг-нормативні-документи"
                            className="block px-4 py-2 hover:bg-gray-100 transition"
                            onClick={() => setOpenSubmenu(false)}
                          >
                        ...
                        <li>
                          <Link
                            to="/стопБулінг-порядок-подання-заяв-про-випадки-булінгу"
                            className="block px-4 py-2 hover:bg-gray-100 transition"
                            onClick={() => setOpenSubmenu(false)}
                          >
                        ...
                        <li>
                          <Link
                            to="/стопБулінг-порядок-реагування-на-доведені-випадки-булінгу"
                            className="block px-4 py-2 hover:bg-gray-100 transition"
                            onClick={() => setOpenSubmenu(false)}
                          >
                  ...
                  <li>
                    <button
                      ...
                      className="block px-4 py-2 hover:bg-gray-100 transition"
                    >
                      Інформація для батьків і учнів
                      <i
                        className={`fi fi-rr-caret-down text-[18px] leading-none transition-transform ${
                          openSubmenu === "info" ? "rotate-180" : ""
                        }`}
                      ></i>
                    </button>
                    {openSubmenu === "info" && (
                      <ul className="mt-2 bg-grey shadow-md rounded-md w-80 py-2 z-50">
                        <li>
                          <Link
                            to="/стопБулінг-як-знущання-проявляються-на-поведінці-дитини"
                            className="block px-4 py-2 hover:bg-gray-100 transition"
                            onClick={() => setOpenSubmenu(false)}
                          >
                        ...
                        <li>
                          <Link
                            to="/стопБулінг-як-реагувати-на-цькування"
                            className="block px-4 py-2 hover:bg-gray-100 transition"
                            onClick={() => setOpenSubmenu(false)}
                          >
                  ...
                  <li>
                    <button
                      onClick={() => toggleSubmenu("additional")}
                      className="block px-4 py-2 hover:bg-gray-100 transition"
                    >
                      Додаткові ресурси
                      <i
                        className={`fi fi-rr-caret-down text-[18px] leading-none transition-transform ${
                          openSubmenu === "additional" ? "rotate-180" : ""
                        }`}
                      ></i>
                    </button>
                    {openSubmenu === "additional" && (
                      <ul className="mt-2 bg-grey shadow-md rounded-md w-80 py-2 z-50">
                        <li>
                          <Link
                            to="/стопБулінг-чат-бот-Кіберпес"
                            className="block px-4 py-2 hover:bg-gray-100 transition"
                            onClick={() => setOpenSubmenu(false)}
                          >
          ...
          <Link to="/запис-до-школи" className="button">
            Запис до школи
          </Link>
        </div>
        ...
        {isMenuOpen && (
          <div className="2xl:hidden fixed top-0 left-0 w-full h-full bg-white z-50 flex flex-col">
            <div className="navbar justify-between flex items-center gap-3">
              ...
              <button
                className="lg:flex xl:hidden p-2 ml-auto w-[40px] h-[40px] flex items-center justify-center"
            ...
            <ul className="flex flex-col gap-4 font-montserrat font-semibold text-[16px] text-black px-5 py-4">
              <li>
                <Link to="/про-нас" onClick={closeAllMenus}>
                  Про нас
                </Link>
              </li>
              <li className="relative">
              ...
              <li>
                <Link to="/розклад-занять" onClick={closeAllMenus}>
                  Розклад занять
                </Link>
              </li>
              <li className="relative">
                      ...
                      {openSubmenu === "documentsBullying" && (
                        <ul className="mt-2 bg-grey shadow-md rounded-md w-full py-2 z-50">
                          ...
                          <li>
                            ...
                            >
                              Порядок подання та розгляду заяв про випадки
                              булінгу
                            </Link>
                          </li>
                          <li>
              ...
              <li>
                <Link to="/контакти" onClick={closeAllMenus}>
                  Контакти
                </Link>
              </li>
            </ul>
