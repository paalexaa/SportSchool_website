    ...
    return (
        <Routes>
            <Route path="/" element={<Layout />}>
              ...
              <Route path="/інформаційнаПрозорість-статус" element={<StatuteDUSH />} />
              <Route path="/інформаційнаПрозорість-правила" element={<Rules />} />
              <Route path="/інформаційнаПрозорість-людиЗОсобливимиПотребами" element={<PeopleWithSpecialNeeds />} />
              <Route path="/інформаційнаПрозорість-освітняПрограма_на_24-25" element={<EducationalProgram />} />
              <Route path="/інформаційнаПрозорість-навчальніПрограми" element={<TrainingPrograms />} />
              <Route path="/інформаційнаПрозорість-мова_та_оплата" element={<LanguageAndPayment />} />
              <Route path="/інформаційнаПрозорість-звітДиректора" element={<DirectorReport />} />
              <Route path="/інформаційнаПрозорість-звіт5ФК" element={<Report5FC />} />
              <Route path="/інформаційнаПрозорість-кількістьВихованців" element={<NumberOfStudents />} />
              <Route path="/інформаційнаПрозорість-умовиВступу" element={<ConditionsForAdmission />} />
              <Route path="/інформаційнаПрозорість-вакансії" element={<Vacancies />} />
              <Route path="/інформаційнаПрозорість-cтруктура-та-органи-управління" element={<StructureManagement />} />

              <Route path="/прозорийБюджет-розрахунок-видатків-на-2025" element={<Estimates2025 />} />
              <Route path="/прозорийБюджет-аналіз-використання-коштів" element={<FundsAnalysis />} />

              <Route path="/стопБулінг-нормативні-документи" element={<NormativeDocuments />} />
              <Route path="/стопБулінг-план-заходів" element={<AntibullyingPlan />} />
              <Route path="/стопБулінг-порядок-подання-заяв-про-випадки-булінгу" element={<ReportBullyingProcedure />} />
              <Route path="/стопБулінг-порядок-реагування-на-доведені-випадки-булінгу" element={<ResponseBullyingProcedure />} />
              <Route path="/стопБулінг-як-знущання-проявляються-на-поведінці-дитини" element={<BullyingBehaviorSigns />} />
              <Route path="/стопБулінг-як-реагувати-на-цькування" element={<HowToHandleBullying />} />
